package tecnicasDeProgramacao.aula01;
...
public class TechKidsOpeningValidator {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        boolean podeCriarConta = validator.isEligibleForTechKids(dataDeNascimento, LocalDate.now());
    ...
    public boolean isEligibleForTechKids(LocalDate dataNascimento, LocalDate dataAtual) {
